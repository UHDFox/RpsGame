...
namespace Domain.Migrations
{
    ...
    [Migration("20250125153531_AddMatchStatus")]
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "match_status", new[] { "finished", "postponed", "pending" });
            ...
            modelBuilder.Entity("Domain.Entities.MatchHistoryRecord", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("PlayerMoves")
                        .IsRequired()
                        .HasColumnType("text[]");
